...
#| fig-cap: "EBCM (lines) vs SSA ribbons (mean ± 1σ). Left: static network (Poisson κ=5, R₀=2). Right: dynamic network with edge turnover (η₁=0.5, η₂=0.3). Edge dynamics reduce the epidemic peak, and the dynamic EBCM tracks the dynamic SSA."
...
p2 = plot(sol_dyn.t, I_dy_ebcm, label = "EBCM", lw = 2, color = :red,
          title = "Dynamic (η₁=0.5, η₂=0.3)", ylims = (0, 0.3))

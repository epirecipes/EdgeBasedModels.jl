...
Figure 1: Figure 1: SIR epidemic on a static Poisson network with mean
degree κ = 5.
...
Figure 2: Figure 2: Comparison of the infected fraction I(t) on static
versus dynamic networks.
...
Figure 3: Figure 3: Effect of edge turnover rate on the epidemic curve.
Faster edge dynamics alter the timing and magnitude of the peak.
...
Figure 4: Figure 4: Edge-level state dynamics during the epidemic on a
dynamic network (η₁=0.5, η₂=0.3). The dormant edge fraction (φ_D) grows
as active edges break.

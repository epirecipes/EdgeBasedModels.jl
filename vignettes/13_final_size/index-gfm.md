...
- [Final Size and Equilibrium
  Analysis](#final-size-and-equilibrium-analysis)
...
Figure 1: Figure 1: Final epidemic size as a function of R₀ for a
Poisson(5) network. The epidemic threshold at R₀ = 1 is marked by a
dashed line.
...
Figure 2: Figure 2: Final size vs transmissibility T for Poisson and
heterogeneous (two-point) networks with the same mean degree κ = 4. The
heterogeneous network has a larger final size and a lower epidemic
threshold.
...
Figure 3: Figure 3: Final size and epidemic probability as functions of
R₀. The epidemic probability is always smaller than the final size: even
when a major epidemic occurs, some individuals escape infection.
...
Figure 4: Figure 4: 95% confidence bands for the final size as a
function of R₀, for population sizes N = 100, 1000, and 10000. Bands
narrow with increasing N.
...
Figure 5: Figure 5: Final size as a function of mean degree κ and
transmissibility T. The white contour marks R∞ = 0.01 (approximate
epidemic threshold). The epidemic region lies above and to the right.

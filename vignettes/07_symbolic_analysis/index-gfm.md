...
Figure 1: Figure 1: R₀ as a function of mean network degree κ, for
anchored β = 1/6 and γ = 0.25. The dashed line marks the epidemic
threshold R₀ = 1.
...
Figure 2: Figure 2: R₀ as a function of transmission rate β, for fixed κ
= 5 and anchored γ = 0.25.
...
Figure 3: Figure 3: Two-stage R₀ as a function of β₁ and β₂, with γ₁ =
0.2, γ₂ = 0.3, κ = 5. The white contour marks R₀ = 1.
...
Figure 4: Figure 4: R₀ for Poisson and polynomial degree distributions,
both with the same mean degree. The Poisson network always has higher R₀
because its excess degree equals its mean degree.

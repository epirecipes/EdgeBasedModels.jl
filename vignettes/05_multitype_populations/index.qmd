...
**Canonical anchor.** This vignette uses $\gamma = 0.25$ and per-edge transmissibility
$T = \beta/(\beta+\gamma) = 0.75$, giving $\beta = T\gamma/(1-T) = 0.75$.
$R_0 = T\,\rho(M)$ where $M$ is the next-generation matrix derived from the contact
structure; preserving $T$ preserves $R_0$.

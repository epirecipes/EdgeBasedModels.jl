...
- [Multi-type Populations](#multi-type-populations)
...
Figure 1: Figure 1: SIR dynamics in a two-type (Young/Old) population.
Young individuals have more contacts and experience a faster, larger
epidemic.
...
Figure 2: Figure 2: Prevalence (infected fraction) comparison between
...
Figure 3: Figure 3: Effect of assortative mixing on epidemic dynamics.
Assortative mixing (dashed) slows the epidemic and reduces final size
compared to homogeneous mixing (solid).
...
Figure 4: Figure 4: Final epidemic size (recovered fraction) under
homogeneous vs assortative mixing.

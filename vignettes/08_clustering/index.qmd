...
# Unclustered
ic1 = merge(default_initial_conditions(model_unclustered; seed_fraction = 0.01), params)
prob1 = ODEProblem(model_unclustered.system, ic1, tspan)
sol1 = solve(prob1, Tsit5(); saveat = 0.5)

# Clustered
ic2 = merge(default_initial_conditions(model_clustered; seed_fraction = 0.01), params)
...
for frac in fracs
    ...
    ic_i = merge(default_initial_conditions(model_i; seed_fraction = 0.01), params)
...
ic_seir = merge(default_initial_conditions(model_seir; seed_fraction = 0.01), params_seir)

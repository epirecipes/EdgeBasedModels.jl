...
- [Degree Correlation and Assortative
  Mixing](#degree-correlation-and-assortative-mixing)
...
Figure 1: Figure 1: Mixing matrices Q(l\|k) for neutral (r=0), mild
(r=0.3), and strong (r=0.8) assortativity. Only degrees 3 and 7 are
present.
...
fixed transmissibility $T = 0.75$ ($\beta = 0.75$, $\gamma = 0.25$).
...
Figure 2: Figure 2: R₀ as a function of assortativity parameter r for a
bimodal degree distribution. Assortativity reduces R₀.
...
Figure 3: Figure 3: R₀ vs assortativity for different degree
distributions. The effect depends on the shape of the distribution.
...
Figure 4: Figure 4: Eigenvalue spectrum of the next-generation matrix
for different levels of assortativity.
...
Figure 5: Figure 5: Difference between correlated R₀ and the standard
uncorrelated R₀ as assortativity increases.
...
Figure 6: Figure 6: Mixing matrix for a disassortative network —
high-degree nodes preferentially connect to low-degree nodes.
